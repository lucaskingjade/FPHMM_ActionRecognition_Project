...
contextualVector{1,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{2,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{3,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{4,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{5,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{6,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{7,1} = [rand*0.001;rand*0.001;rand*0.001]
contextualVector{8,1} = [rand*0.001;rand*0.001;rand*0.001]
