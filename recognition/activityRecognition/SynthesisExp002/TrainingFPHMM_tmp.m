...
%         clear tmpData;
		...
		if multinomial ==1
			contextualVector{indEm,1}(4,1) = contextualVector{indEm,1}(1,1)^2;
			contextualVector{indEm,1}(5,1) = contextualVector{indEm,1}(2,1)^2;
			contextualVector{indEm,1}(6,1) = contextualVector{indEm,1}(3,1)^2;
			contextualVector{indEm,1}(7,1) = contextualVector{indEm,1}(1,1)*contextualVector{indEm,1}(2,1);
			contextualVector{indEm,1}(8,1) = contextualVector{indEm,1}(1,1)*contextualVector{indEm,1}(3,1);
			contextualVector{indEm,1}(9,1) = contextualVector{indEm,1}(2,1)*contextualVector{indEm,1}(3,1);
