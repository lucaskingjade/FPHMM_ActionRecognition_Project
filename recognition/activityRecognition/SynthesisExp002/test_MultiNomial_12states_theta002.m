...
x=rand(2,1);
contextualVector{1,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{2,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{3,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{4,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{5,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{6,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{7,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
x=rand(2,1);
contextualVector{8,1} = [x(1,1);x(2,1);x(1,1)^2;x(2,1)^2;x(1,1)*x(2,1)];
