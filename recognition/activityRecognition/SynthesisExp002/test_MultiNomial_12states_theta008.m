...
x=rand(3,1);
contextualVector{1,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{2,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{3,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{4,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{5,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{6,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{7,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
x=rand(3,1);
contextualVector{8,1} = [x(1,1);x(2,1);x(3,1);x(1,1)^2;x(2,1)^2;x(3,1)^2;x(1,1)*x(2,1);x(1,1)*x(3,1);x(2,1)*x(3,1)];
...
save_file_name = strcat(save_path,num2str(numActivity),'Act_',num2str(numEmotion),'Em_',num2str(size(Names,2)),...
    'Actors_',num2str(theta_dim),'thetadim_',str1,'_',str2,'_',num2str(FPHMM_HMM_init_Iter),'+',num2str(mxIter_FPHMM),'MultiNomialFPHMM_',num2str(timestr(1)),'_',num2str(timestr(2)),'_',...
