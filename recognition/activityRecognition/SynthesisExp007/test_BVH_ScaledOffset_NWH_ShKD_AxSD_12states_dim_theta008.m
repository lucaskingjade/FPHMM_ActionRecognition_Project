...
ExperimentName = 'SynthesisExp007';
...
MissingPairs = {'Neutral','Walk with smth in the Hands';'Shame','Knocking on the Door';'Anxiety','Sitting Down'};
...
MissingStr ='NWH_ShKD_AxSD_RmFirst3Dims_Unscaled_';
LoadDataName ='DataSetOffSet4thDim_RmFirst3Dims_UnScaled_16PCA_Bvh_NWH_ShKD_AxSD.mat'
