...
MissingPairs = {'Sadness','Simple Walk';'Neutral','Walk with smth in the Hands'};
...
MissingStr ='SdSW_NtWH_RmFirst3Dims_Unscaled_';
LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_SdSW_NtWH_Smaller.mat'
