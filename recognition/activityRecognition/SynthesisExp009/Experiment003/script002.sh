...
MissingPair="MissingPairs = {'Neutral','Simple Walk';'Pride','Walk with smth in the Hands'};"
MissStr="MissingStr ='NtSW_PrWH_RmFirst3Dims_Unscaled_';"
LoadName="LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_NtSW_PrWH.mat'"
