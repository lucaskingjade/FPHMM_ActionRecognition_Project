...
#OLD="SdSW_PrWH"
#NEW="SdSW_NtWH"
DPATH="../Experiment006/test_BVH_2Activity_20PCA_MissPairs*.m"
...
new="LoadDataName ='..\/..\/DataSet\/DataSetOffSetFirst4Dim"
for f in $DPATH
do
#	sed -i "s/.mat/_Smaller.mat/g" "$f"
#	sed -i "s/.mat7-binary/-mat7-binary/g" "$f"
#	sed -i -e "s/_Smaller-mat7-binary/-mat7-binary/g" "$f"
sed -i -e "s/LoadDataName ='DataSetOffSetFirst4Dim/$new/g" "$f"
