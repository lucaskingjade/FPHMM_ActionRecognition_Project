...
MissingPair="MissingPairs = {'Pride','Simple Walk';'Sadness','Walk with smth in the Hands'};"
MissStr="MissingStr ='PrSW_SdWH_RmFirst3Dims_Unscaled_';"
LoadName="LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PrSW_SdWH.mat'"
