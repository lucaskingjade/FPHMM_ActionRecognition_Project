...
MissingPairs = {'Pride','Simple Walk';'Sadness','Walk with smth in the Hands'};
...
MissingStr ='PrSW_SdWH_RmFirst3Dims_Unscaled_';
LoadDataName ='../../DataSet/DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PrSW_SdWH_Smaller.mat'
...
save('-mat7-binary',strcat(save_file_name,'_Smaller.mat'),'FPHMMCell');
