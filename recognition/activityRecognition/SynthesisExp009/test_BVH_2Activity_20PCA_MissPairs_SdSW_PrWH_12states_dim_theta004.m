...
contextualVector{1,1} = [rand;rand;rand;rand];
contextualVector{2,1} = [rand;rand;rand;rand];
contextualVector{3,1} = [rand;rand;rand;rand];
contextualVector{4,1} = [rand;rand;rand;rand];
contextualVector{5,1} = [rand;rand;rand;rand];
contextualVector{6,1} = [rand;rand;rand;rand];
contextualVector{7,1} = [rand;rand;rand;rand];
contextualVector{8,1} = [rand;rand;rand;rand];
