...
MissingPairs = {'Pride','Simple Walk';'Neutral','Walk with smth in the Hands'};
...
MissingStr ='PrSW_NtWH_RmFirst3Dims_Unscaled_';
LoadDataName ='DatASetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PrSW_NtWH.mat'

load(LoadDataName);
theta_dim = 8;
contextualVector = cell(numEmotion,1);% save thetas values
contextualVector{1,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{2,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{3,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{4,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{5,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{6,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{7,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
contextualVector{8,1} = [rand;rand;rand;rand;rand;rand;rand;rand];
%isFixed = [0 0 0 1 0 0 0 0];

TrainingFPHMM_Synthesis;
save_path = strcat(path0,'fullyParameterizedHMM/Project/recognition/activityRecognition/',ExperimentName,'/',subEmperiment,'/Results/');
if isRandomInit ==1
    str1 = 'RandInit';
else
    str1 = 'fixedInit';
