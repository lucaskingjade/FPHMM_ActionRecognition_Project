...
MissingPairs = {'Panic Fear','Simple Walk';'Anger','Walk with smth in the Hands'};
...
MissingStr ='PfSW_AgWH_RmFirst3Dims_Unscaled_';
LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PfSW_AgWH.mat'
