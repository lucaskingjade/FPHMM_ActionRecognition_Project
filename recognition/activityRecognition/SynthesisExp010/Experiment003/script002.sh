...
MissingPair="MissingPairs = {'Panic Fear','Simple Walk';'Anxiety','Walk with smth in the Hands'};"
MissStr="MissingStr ='PfSW_AxWH_RmFirst3Dims_Unscaled_';"
LoadName="LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PfSW_AxWH.mat'"
