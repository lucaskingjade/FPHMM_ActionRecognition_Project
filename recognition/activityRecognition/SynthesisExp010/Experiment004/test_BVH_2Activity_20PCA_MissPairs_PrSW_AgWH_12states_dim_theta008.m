...
MissingPairs = {'Pride','Simple Walk';'Anger','Walk with smth in the Hands'};
...
MissingStr ='PrSW_AgWH_RmFirst3Dims_Unscaled_';
LoadDataName ='DataSetOffSetFirst4Dim_2Activity_Unscaled_20PCA_SW_WH_PrSW_AgWH.mat'
